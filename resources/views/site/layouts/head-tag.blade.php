...
<link rel="stylesheet" href="{{asset('app-assets/css/style.css?v='.hash('sha256','1.4'))}}">
<link rel="stylesheet" href="{{ asset('site-assets/css/service-menu.css?v='.hash('sha256','1.2'))}}">
