                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <select name="is_show_on_home" id="is_show_on_home" class="form-control form-control-sm">
                                    <option value="0" @if(old('is_show_on_home',$faq->is_show_on_home) == 0) selected @endif>غیرفعال</option>
                                    <option value="1" @if(old('is_show_on_home',$faq->is_show_on_home) == 1) selected @endif>فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
